...
namespace Proxies\__CG__\WS\OvsBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Sport extends \WS\OvsBundle\Entity\Sport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'WS\\OvsBundle\\Entity\\Sport' . "\0" . 'id', '' . "\0" . 'WS\\OvsBundle\\Entity\\Sport' . "\0" . 'nom', '' . "\0" . 'WS\\OvsBundle\\Entity\\Sport' . "\0" . 'evenements');
        }
