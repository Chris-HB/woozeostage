...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'ws_chat_chat_index');
            }

            return array (  '_controller' => 'WS\\ChatBundle\\Controller\\ChatController::indexAction',  '_route' => 'ws_chat_chat_index',);
        }

        // ws_chat_listUser
        if ($pathinfo === '/listUser') {
            return array (  '_controller' => 'WS\\ChatBundle\\Controller\\ChatController::listUserAction',  '_route' => 'ws_chat_listUser',);
        }

        // ws_chat_voir
        if ($pathinfo === '/voir') {
            return array (  '_controller' => 'WS\\ChatBundle\\Controller\\ChatController::voirAction',  '_route' => 'ws_chat_voir',);
        }

        if (0 === strpos($pathinfo, '/hello')) {
            // ws_chat_default_index
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ws_chat_default_index')), array (  '_controller' => 'WS\\ChatBundle\\Controller\\DefaultController::indexAction',));
            }

            // ws_user_default_index
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ws_user_default_index')), array (  '_controller' => 'WS\\UserBundle\\Controller\\DefaultController::indexAction',));
            }
